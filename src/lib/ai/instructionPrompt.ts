export const instructionPrompt = `# Prompt systemowy - zachowanie chatu
...
## Output Format:
You must return the result as a valid JSON object in Polish, with four keys: "punkty_sporne" (disputed points), "punkty_do_negocjacji" (negotiable points), "punkty_zgodne" (agreed points), and "propozycja_porozumienia" (settlement proposal).
