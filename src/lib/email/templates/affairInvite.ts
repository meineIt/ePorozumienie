...
export function getAffairInviteEmailTemplate(affairTitle: string, inviteLink: string): string {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h2 style="color: #0A2463;">Zaproszenie do mediacji</h2>
      <p>Witaj,</p>
      ...
      <p>Aby dołączyć do sprawy i rozpocząć proces mediacji, musisz utworzyć konto w systemie e-Porozumienie.</p>
