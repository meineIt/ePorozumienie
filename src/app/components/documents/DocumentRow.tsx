...
export default function DocumentRow({ document, onClick, getDocumentIcon }: DocumentRowProps) {
  return (
    ...
    >
      <div className={`w-10 h-10 rounded-lg ${getCategoryColor(document.category)} flex items-center justify-center shrink-0`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-4 mt-1 text-sm text-gray-500">
          ...
          <span className="flex items-center gap-1">
            ...
            {document.affairTitle}
          </span>
        </div>
      </div>
      <div className="px-3 py-1 bg-gray-100 rounded text-xs font-semibold text-gray-700 shrink-0">
