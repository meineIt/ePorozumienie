      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 md:mb-8 text-white leading-tight tracking-tight">
            Porozumienie w 3 kliknięcia
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl mb-10 md:mb-12 text-white/90 leading-relaxed max-w-3xl mx-auto">
            Pierwsza platforma do <strong className="font-semibold">mediacji online</strong>, która wykorzystując AI
            <br className="hidden md:block" />
            <span className="md:inline">rozwiązuje spory w </span><strong className="font-semibold">3 dni</strong> zamiast 15 miesięcy!
          </p>
