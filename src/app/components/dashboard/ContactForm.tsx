...
export default function ContactForm({ userEmail, userName }: ContactFormProps) {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      <div className="bg-gradient-to-br from-[#0A2463] to-[#3E5C95] px-6 py-4 relative overflow-hidden">
        {/* Pattern with pluses */}
        <div 
        ...
        />
        <h1 className="text-2xl font-bold text-white relative z-10">Skontaktuj się z nami</h1>
        <p className="text-blue-100 text-sm mt-1 relative z-10">Masz pytania? Pojawił sie błąd?</p>
      </div>
